...
/**
 * 系统登录的重要信息保存或者处理到SESSION中 session的有效期在web.xml中设置 有效时间的范围以分钟为单位最长时间24小时(1440)
 *
 ...
 * <script language=javascript> function keepsession(){
 ...
 * </script>
 * 同一目录下建一个空内容的sessionKeeper.asp就文件就可以了
 *
 * @author 1101399
